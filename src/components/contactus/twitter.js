...
import twitterimg from './twitter.JPG';
        ...
        return (
            ...
            <nav>
                <ul className="pure-menu pure-menu-horizontal">
                    ...
                    <img src={twitterimg} alt="Home" className="homeIcon" /> Home</Link></li>
            ...
            <section className="pad15">
                <img src={twitterimg} className="pressIcon" alt="Contact Us"/>

                <h4>Contact Us at:<br></br> https://twitter.com/MDeribie</h4>
            </section>
        </div>
        );
    }
