...
import headlinesimg from "./headlines.JPG";
        ...
        return (
            ...
            <nav>
                <ul className="pure-menu pure-menu-horizontal">
                    ...
                    <img src={headlinesimg} alt="Home" className="homeIcon" /> Home</Link></li>
            ...
            <section className="pad15">
                <img src={headlinesimg} className="pressIcon" alt="About Us"/>
