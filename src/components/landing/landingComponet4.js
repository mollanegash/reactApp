...
class landingComponet4 extends React.Component {
    constructor(props) {
        super(props);
    }
        ...
        return (
            <div>
                ...
                {/* <nav>
                    <ul className="pure-menu pure-menu-horizontal">
                        <li className="pure-menu-item"><Link className="pure-menu-link" to="/">
                            <img src={homeImg} alt="Home" className="homeIcon" /> Home</Link></li>
                ...
                <section className="pad15">
                    <img src={aboutImg} className="pressIcon" alt="About Us"/>
...
export default landingComponet4;